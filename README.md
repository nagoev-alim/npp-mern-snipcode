<h2 align="center">🌐 SnipCode</h2>
<p align="center">Place to store your code snippets</p>

-----

#### 📦 Previews
![App Screenshot](client/public/assets/images/preview/1.png)
![App Screenshot](client/public/assets/images/preview/2.png)
![App Screenshot](client/public/assets/images/preview/3.png)
![App Screenshot](client/public/assets/images/preview/4.png)
![App Screenshot](client/public/assets/images/preview/5.png)
...
| [express-async-handler](github.com/Abazhenov/express-async-handler) | Simple middleware for handling exceptions inside of async express routes and passing them to your express error handlers.  |
